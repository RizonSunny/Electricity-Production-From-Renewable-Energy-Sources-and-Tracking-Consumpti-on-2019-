...
<div class="container">
  ...
  <table class="table table-condensed">
    ...
    <tbody>
      <tr>
        <td><a  href="http://localhost:8000/flat1">Flat 1</a></td>
        <td>{{$one['1019']}}</td>
        @if($one['1019']>$warning)
        <td>Limit Crossed</td>
        @else
      ...
      <tr>
        <td><a  href="http://localhost:8000/flat2">Flat 2</a></td>
        <td>{{$two['1019']}}</td>
        @if($two['1019']>$warning)
        <td>Limit Crossed</td>
        @else
      ...
      <tr>
        <td><a  href="http://localhost:8000/flat3">Flat 3</a></td>
        <td>{{$three['1019']}}</td>
        @if($three['1019']>$warning)
        <td>Limit Crossed</td>
        @else
        <td>Under Limit</td>
        @endif
