    ...
    <div class="container">
      <div class="row">
        <div class="col-xl-9 mx-auto">
          <h1 class="mb-5">Creating Power Independence</h1>
        </div>
    ...
    <div class="container-fluid p-0">
      <div class="row no-gutters">
        ...
        <div class="col-lg-6 order-lg-1 my-auto showcase-text">
          <h2><a  href="#">Solar Energy</a></h2>
          <p class="lead mb-0">Uses the never-ending light of the sun </p>
        </div>
      </div>
    </div>
  </section>
